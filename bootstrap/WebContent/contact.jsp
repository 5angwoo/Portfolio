...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <p>Stay in Touch!! Don't be hesitated to give me a question about myself or whatever you would like to know among I can answer!</p>
                ...
                <form name="sentMessage" id="contactForm" novalidate>
                    ...
                    <div class="row control-group">
                        <div>
                            Email : tghan77@naver.com
                        </div>
                    </div>
                    <div class="row control-group">
                        <div>
                            Phone Number : 010 4556 2897     
                        </div>
                    </div>
