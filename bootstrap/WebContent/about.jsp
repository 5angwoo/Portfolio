...
<body>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>저는요</h1>
                        <hr class="small">
                        <span class="subheading">간단합니다.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <h4>Positive</h4>
                - Go straight even if i m slower than others.<br>
                Speed is not important but DIRECTION.
                <h4>Diligent</h4>
                - Everybody can say 'I can do it.'. But I do it.                
                <h4>Fun</h4>
                - Please Help me up Escaping Hundred hands.
            </div>
        </div>
        <br><br><center><h4>저에 대해 더 알고 싶으신가요?</h4></center>
    </div>
