...
<%
	...
	try {
		con = DriverManager.getConnection(
				"jdbc:mysql://localhost:3306/member?useUnicode=true&characterEncoding=euckr", "root", "1234");
...
<body>
	<form name="join" method="post" action="modify_session.jsp">
		...
		<table width="500" border="1" bordercolorlight="#999999"
			bordercolordark="#FFFFFF" cellpadding="3" cellspacing="0"
			align="center" class=style2>
			<tr align="center">
				<td colspan="2" background="image/sky_bar.gif"><%=username%>
					회원님의 개인정보는 다음과 같습니다.</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="button"
					value="확   인" onClick="location='index.jsp'"> <input
					type="button" value="수   정"
					onClick="location='modify_session.jsp?mode=modify'"> <input
					type="button" value="회원 탈퇴" onClick="location='delete.jsp'">
				</td>
			</tr>
		</table>
	</form>
